...
ARG_PARSER.add_argument('--json-in',
                        help="JSON file generated by logscrape.py")
ARG_PARSER.add_argument('--png-out',
    ...
    for thread_idx, thread in enumerate(THREADS):
        ...
        for conn_idx, conn in enumerate(thread['connections']):
            ...
            conn_middle_y = conn_bottom_y + \
                (HEIGHT_PER_CONN * conn['visual_idx']) + (HEIGHT_PER_CONN * 0.5)
...
with PerfTimer('save-img'):
    plt.savefig(args.png_out, format='png')
