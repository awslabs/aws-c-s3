...
// - BranchName (string): The branch of project.
...
function stack_deploy(project_name, branch_name) {
  const project_name_config = " -c ProjectName=" + project_name;
  const branch_name_config = " -c BranchName=" + branch_name;
...
if (process.env.PROJECT_NAME) {
  ...
  stack_deploy(project_name, branch_name);
} else {
