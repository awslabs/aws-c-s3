...
static int s_crc64nvme_nist_test_case_3_truncated_fn(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;
...
AWS_TEST_CASE(crc64nvme_nist_test_case_3_truncated, s_crc64nvme_nist_test_case_3_truncated_fn)
...
static int s_crc64nvme_test_invalid_buffer_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERT_ERROR(AWS_ERROR_SHORT_BUFFER, aws_checksum_compute(allocator, AWS_SCA_CRC64NVME, &input, &output_buf, 0));
