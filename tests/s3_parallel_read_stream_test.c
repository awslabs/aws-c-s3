...
// static void s_s3_parallel_from_file_read_test_task(struct aws_task *task, void *arg, enum aws_task_status
// task_status) {
//     (void)task_status;
...
//     struct aws_parallel_input_stream *parallel_read_stream =
//         aws_parallel_input_stream_new_from_file(allocator, path_cursor, NULL);
