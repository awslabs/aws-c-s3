...
enum aws_s3_errors {
    ...
    /* Deprecated: this name was inaccurate (it's not part-size specific). Kept as an alias of
     * AWS_ERROR_S3_INTERNAL_BUFFER_SIZE_MISMATCH_RETRYING_WITH_RANGE for source/binary compatibility.
     * Use AWS_ERROR_S3_INTERNAL_BUFFER_SIZE_MISMATCH_RETRYING_WITH_RANGE instead. */
