...
static struct aws_error_info s_errors[] = {
    ...
    AWS_DEFINE_ERROR_INFO_S3(AWS_ERROR_S3_SKIP_UPLOADED_PART_FAILED, "Failed to skip previously uploaded part"),
    AWS_DEFINE_ERROR_INFO_S3(AWS_ERROR_S3_UPLOADED_PART_CHECKSUM_MISMATCH, "Checksum does not match previously uploaded part"),
};
/* clang-format on */
