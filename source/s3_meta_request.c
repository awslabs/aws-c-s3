...
int aws_s3_meta_request_init_base(
    ...
    *((bool *)&meta_request->should_compute_content_md5) = should_compute_content_md5;
    aws_checksum_config_impl_init(meta_request->allocator, &meta_request->checksum_config, options->checksum_config);
...
static void s_s3_meta_request_destroy(void *user_data) {
    ...
    aws_checksum_config_impl_cleanup(&meta_request->checksum_config);
