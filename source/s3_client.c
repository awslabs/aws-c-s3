        ...
        case AWS_S3_META_REQUEST_TYPE_PUT_OBJECT: {
            ...
            if (options->resume_token == NULL) {
                ...
                if (content_length_found) {
                    ...
                    uint64_t aligned_out_part_size =
                        aws_s3_buffer_pool_align_range_size(client->buffer_pool, out_part_size);
                    /* Incase of overflow, fallback to no alignment. */
                    aligned_out_part_size = aligned_out_part_size > SIZE_MAX ? out_part_size : aligned_out_part_size;
                    part_size = (size_t)aligned_out_part_size;
                }
